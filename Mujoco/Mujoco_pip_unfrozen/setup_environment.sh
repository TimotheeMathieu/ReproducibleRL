...
python3 -m venv $venv_dir && source ${venv_dir}/bin/activate && python3 -m pip install --upgrade pip && python3 -m pip install -r requirements.txt && python3 ../run_ppo.py $1 && pip freeze --all > ${1}/server_env_explicit.txt
clean
}
